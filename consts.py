...
type_map = {}
type_map["Normal"] = NORMAL
type_map["Fighting"] = FIGHTING
type_map["Flying"] = FLYING
type_map["Poison"] = POISON
type_map["Ground"] = GROUND
type_map["Rock"] = ROCK
type_map["Bird"] = BIRD
type_map["Bug"] = BUG
type_map["Ghost"] = GHOST
type_map["Fire"] = FIRE
type_map["Water"] = WATER
type_map["Grass"] = GRASS
type_map["Electric"] = ELECTRIC
type_map["Psychic"] = PSYCHIC_TYPE
type_map["Ice"] = ICE
type_map["Dragon"] = DRAGON
